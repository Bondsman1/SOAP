...
namespace json_spirit
{
    ...
    class Generator
    {
        ...
        typedef typename String_type::value_type Char_type;
        typedef typename Object_type::value_type Obj_mSoap_type;
    ...
    private:
        ...
        void output( const Obj_mSoap_type& mSoap )
        {
            output( Config_type::get_name( mSoap ) ); space(); 
            os_ << ':'; space(); 
            output( Config_type::get_value( mSoap ) );
        }
